...
interface EnrollmentProgramDao {
	fun insertStudentInProgram(credential: Credential, campusName: Name, programName: Name): Either<EnrollmentException, Unit>
	fun removeStudentFromProgram(username: Username, campusName: Name, programName: Name): Either<EnrollmentException, Unit>
