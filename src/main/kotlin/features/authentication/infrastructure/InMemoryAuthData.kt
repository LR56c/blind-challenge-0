...
class InMemoryAuthData(override var token: String = "") : AuthenticationRepository {
	...
	override fun logout(username: Username): Either<InvalidAuthenticationException, Unit> = either {
		token = ""
	}
}
